#ifndef artdaq_demo_Overlays_HTG710FixedDMAFragment_hh
#define artdaq_demo_Overlays_HTG710FixedDMAFragment_hh

#include "artdaq-core/Data/Fragment.hh"

#include <ostream>

// Implementation of "HTG710FixedDMAFragment", an artdaq::Fragment overlay class
...
namespace demo {
  class HTG710FixedDMAFragment;

  // Let the "<<" operator dump the HTG710FixedDMAFragment's data to stdout
  std::ostream & operator << (std::ostream &, HTG710FixedDMAFragment const &);
}

class demo::HTG710FixedDMAFragment {
  public:

  // The "Metadata" struct declared here is used to define the set of
  // information that is stored in the "metadata" section of
  // artdaq::Fragments that contain HTG710FixedDMAFragments in their payload.
  // This struct is not used by the HTG710FixedDMAFragment Overlay class itself;
  ...
  // HTG710FixedDMAFragment::Metadata::size_words )
  ...
  static_assert (sizeof (Metadata) == Metadata::size_words * sizeof (Metadata::data_t), "HTG710FixedDMAFragment::Metadata size changed");


  // HTG710FixedDMAFragment is intended to represent/interpret data that has an
  ...
  static_assert (sizeof (Header) == Header::size_words * sizeof (Header::data_t), "HTG710FixedDMAFragment::Header size changed");

  // The constructor simply sets its const private member "artdaq_Fragment_"
  // to refer to the artdaq::Fragment object

  HTG710FixedDMAFragment(artdaq::Fragment const & f ) : artdaq_Fragment_(f) {}
  ...
  // Defined in HTG710FixedDMAFragment.cc, this throws if any ADC appears corrupt
  ...
  // data (i.e., where the HTG710FixedDMAFragment::Header object begins) and
  // casts it as a pointer to HTG710FixedDMAFragment::Header

  Header const * header_() const {
    return reinterpret_cast<HTG710FixedDMAFragment::Header const *>(artdaq_Fragment_.dataBeginBytes());
  }
...
#endif /* artdaq_demo_Overlays_HTG710FixedDMAFragment_hh */
